...
public class RequestHandler extends Handler {
     ...
     */
    public RequestHandler(DestinationLogic destinationLogic, CalendarTagDao calendarTagDao,
     ...
     * @param favouritePlaceDao DAO for favourite places
     */
    public RequestHandler(Context context, DestinationLogic destinationLogic, CalendarTagDao calendarTagDao,
                          PlaceDao placeDao, RouteSearchDao routeSearchDao, FavouritePlaceDao favouritePlaceDao) {
