...
public class MainActivityTest extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calendarConnection = mock(CalendarConnection.class);
